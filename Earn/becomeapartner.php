...
<html lang="ko" dir="ltr">
  <head>
    ...
    #become_section1 button{
      width:200px;
      height:40px;
      background-color: rgba(139,167,83,118);
      color:rgb(245,245,244,230);
      border:none;
      border-radius: 5px;
    }
    #become_section1 button:hover{
      width:200px;
      height:40px;
      background-color: rgba(151,177,98,129);
      color:rgb(245,245,244,230);
      border: none;
      border-radius: 5px;
    }
  ...
  <body>
    ...
    <div id="become_section">
      <div id="become_section1">
        <img src="" alt="">
        <h1>Apply to become an affilate partner</h1>
      ...
      <div id="become_section3">
        <h1>Referrals Last Up to an Entire Year</h1>
      ...
      <div id="become_section6">
        ...
        <input type="button" name="" value="Become a Partner">
      </div>
    </div>
